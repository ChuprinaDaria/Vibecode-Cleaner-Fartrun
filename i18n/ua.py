STRINGS = {
    ...
    "about_author": "Зроблено Дарією Чупріною\nбо вона може \U0001f47e\n\nMade by Daria Chuprina\nbecause she can \U0001f47e",
    "side_about": "Про програму",
    ...
    "enable_popup": "Показувати popup-сповіщення в додатку",
    ...
    "frozen_hook_install_failed": "Не вдалося встановити Claude Code hook. "
                                    ...
                                    "блокування не буде.",
    "frozen_smart_placeholder": "Опиши що працює і не треба чіпати, напр.: "
                                "\"логін, оплати, авторизація\"",
    "frozen_smart_btn": "Знайти і заблокувати",
    "frozen_smart_searching": "Шукаю файли...",
    "frozen_smart_no_key": "Встановіть HaikuHoff API ключ в налаштуваннях.",
    "frozen_smart_no_files": "Не знайшов підходящих файлів. Спробуй описати конкретніше.",
    "frozen_smart_confirm": "Знайдено {} файл(ів) за описом.\nЗаблокувати всі?",
    "frozen_smart_done": "Заблоковано {} файл(ів).",
