STRINGS = {
    ...
    "enable_popup": "Show popup alerts in app",
    ...
    "frozen_hook_install_failed": "Failed to install the Claude Code hook. "
                                    ...
                                    "no hard block.",
    "frozen_smart_placeholder": "Describe what works and shouldn't be touched, e.g.: "
                                "\"login, payments, auth flow\"",
    "frozen_smart_btn": "Find & lock",
    "frozen_smart_searching": "Searching for files...",
    "frozen_smart_no_key": "Set HaikuHoff API key in Settings to use smart lock.",
    "frozen_smart_no_files": "Couldn't find matching files. Try being more specific.",
    "frozen_smart_confirm": "Found {} file(s) matching your description.\nLock them all?",
    "frozen_smart_done": "Locked {} file(s).",
